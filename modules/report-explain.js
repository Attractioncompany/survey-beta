...
(function (root) {
  ...
  var WIDTH = {
    interocular: {
      hi: ["두 눈 사이가 멀어서 얼굴 가운데에 여백이 넓습니다.",
           "두 눈 사이가 멀어서 얼굴 가운데가 넓게 보여요. 인상이 느긋하게 읽히는 배치입니다."],
    ...
    face_HW: {
      hi: ["얼굴이 갸름한 편입니다. 목·어깨를 덮기보다 열어 두면 그 세로선이 그대로 이어집니다.",
           "얼굴이 갸름해서 세로선이 살아나고, 어깨까지 이어지는 선이 길어 보여요."],
