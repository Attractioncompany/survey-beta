...
(function (root) {
  ...
  function selfRatio(ratio, quality) {
    ...
    /* 「상 : 중 : 하」 행은 뺐다 — 이론 판정 2026-08-27
       (theory/회신_상중하안부_분할점_판정_2026-08-27.md · 강의 리포트와 같이 내린다).
       08-24에 "황금비율 기준은 1:1:1"이라는 꼬리 문장만 순화했는데, 그건 세 겹 중 하나였다.
       남아 있던 둘: 1:1:1은 우리 인구의 이상이 아니고(사내 규준 조사 08-17 —
       한국 여성 n=40 중안부:하안부 41.6:58.4, 홍콩 n=103 3등분 충족률 0%),
       대는 자와 재는 자가 달랐다(오늘 미간으로 교정하기 전까지).
       분할점을 옮겨도 앞의 둘은 남으므로 행 자체를 내린다. */
    return out;
  }
