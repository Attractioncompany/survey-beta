...
export const OBS = {
  eye_angle: { hi:{c:"눈꼬리가 눈머리보다 올라가 있고", e:"눈꼬리가 눈머리보다 올라가 있어서요", d:"눈꼬리가 눈머리보다 올라가 있어요"},
               lo:{c:"눈꼬리가 눈머리보다 내려와 있고", e:"눈꼬리가 눈머리보다 내려와 있어서요", d:"눈꼬리가 눈머리보다 내려와 있어요"} },
  ...
  interocular: { hi:{c:"두 눈 사이가 눈 하나 길이보다 넓고", e:"두 눈 사이가 눈 하나 길이보다 넓어서요", d:"두 눈 사이가 눈 하나 길이보다 넓어요"},
                 lo:{c:"두 눈 사이가 눈 하나 길이보다 좁고", e:"두 눈 사이가 눈 하나 길이보다 좁아서요", d:"두 눈 사이가 눈 하나 길이보다 좁아요"} },
  mouth_w: { hi:{c:"얼굴 너비에 비해 넓고", e:"얼굴 너비에 비해 넓어서요", d:"얼굴 너비에 비해 넓어요"},
             lo:{c:"얼굴 너비에 비해 좁고", e:"얼굴 너비에 비해 좁아서요", d:"얼굴 너비에 비해 좁아요"} },
  ...
  face_HW: { hi:{c:"얼굴이 가로보다 세로로 길고", e:"얼굴이 가로보다 세로로 길어서요", d:"얼굴이 가로보다 세로로 길어요"},
             lo:{c:"얼굴 가로와 세로가 비슷하고", e:"얼굴 가로와 세로가 비슷해서요", d:"얼굴 가로와 세로가 비슷해요"} },
  chin_len: { hi:{c:"코밑에서 턱끝까지가 길고", e:"코밑에서 턱끝까지가 길어서요", d:"코밑에서 턱끝까지가 길어요"},
              lo:{c:"코밑에서 턱끝까지가 짧고", e:"코밑에서 턱끝까지가 짧아서요", d:"코밑에서 턱끝까지가 짧아요"} },
  parts_vpos: { hi:{c:"눈·코·입이 얼굴 아래쪽에 놓이고", e:"눈·코·입이 얼굴 아래쪽에 놓여서요", d:"눈·코·입이 얼굴 아래쪽에 놓여 있어요"},
                lo:{c:"눈·코·입이 얼굴 위쪽에 놓이고", e:"눈·코·입이 얼굴 위쪽에 놓여서요", d:"눈·코·입이 얼굴 위쪽에 놓여 있어요"} },
  skinL: { hi:{c:"피부가 밝고", e:"피부가 밝아서요", d:"피부가 밝은 편이에요"},
           lo:{c:"피부가 어둡고", e:"피부가 어두워서요", d:"피부가 어두운 편이에요"} },
  chroma: { hi:{c:"피부색이 진하고", e:"피부색이 진해서요", d:"피부색이 진한 편이에요"},
            lo:{c:"피부색이 옅고", e:"피부색이 옅어서요", d:"피부색이 옅은 편이에요"} },
  contrast: { hi:{c:"피부·눈·머리 색 차이가 크고", e:"피부·눈·머리 색 차이가 커서요", d:"피부·눈·머리 색 차이가 커요"},
              lo:{c:"피부·눈·머리 색 차이가 작고", e:"피부·눈·머리 색 차이가 작아서요", d:"피부·눈·머리 색 차이가 작아요"} },
};
...
export function selfCheck() {
  ...
  ok(re.line.includes("눈꼬리가 눈머리보다 내려와 있고"), "관찰 어휘 매핑");
  // 8) 금지어가 산출물에 없다
  ...
  ok(r2.line.endsWith("두 눈 사이가 눈 하나 길이보다 넓어요."), "마지막 관찰이 평서 종결형");
  ...
  return "part-report selfCheck 통과 (19/19)";
}
