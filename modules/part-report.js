...
// [마케팅 검수 전] — 어휘 확정은 마케팅 소관이며, 확정본이 오면 이 표만 교체한다.
const OBS = {
  ...
  eye_len:        { hi:{c:"눈이 시원하게 자리를 잡고",  e:"눈이 시원하게 자리를 잡아서요"},
                    lo:{c:"눈이 아담하게 모이고",       e:"눈이 아담하게 모여서요"} },
  ...
  chroma:         { hi:{c:"색이 또렷하게 살아나고",     e:"색이 또렷하게 살아나서요"},
                    lo:{c:"색이 은은하게 가라앉고",     e:"색이 은은하게 가라앉아서요"} },
  contrast:       { hi:{c:"이목구비 대비가 뚜렷하고",   e:"이목구비 대비가 뚜렷해서요"},
                    lo:{c:"전체가 부드럽게 어우러지고", e:"전체가 부드럽게 어우러져서요"} },
};
