...
export const OBS = {
  ...
  chin_len:       { hi:{c:"턱이 길게 떨어지고", e:"턱이 길게 떨어져서요", d:"턱이 길게 내려와 있어요"},
                    lo:{c:"턱이 야무지게 자리 잡고", e:"턱이 야무지게 자리 잡아서요", d:"턱이 야무지게 자리 잡았어요"} },
  parts_vpos:     { hi:{c:"이목구비가 아래쪽에 모이고", e:"이목구비가 아래쪽에 모여서요", d:"이목구비가 아래쪽에 모여 있어요"},
                    lo:{c:"이목구비가 위쪽에 자리하고", e:"이목구비가 위쪽에 자리해서요", d:"이목구비가 위쪽에 자리하고 있어요"} },
  skinL:          { hi:{c:"피부가 환하게 밝고", e:"피부가 환하게 밝아서요", d:"피부가 환하게 밝아요"},
                    lo:{c:"피부가 차분하게 가라앉고", e:"피부가 차분하게 가라앉아서요", d:"피부가 차분하게 가라앉아 있어요"} },
  chroma:         { hi:{c:"색이 또렷하게 살아나고", e:"색이 또렷하게 살아나서요", d:"색이 또렷하게 살아 있어요"},
                    lo:{c:"색이 은은하게 번지고", e:"색이 은은하게 번져서요", d:"색이 은은하게 번져 있어요"} },
  contrast:       { hi:{c:"이목구비 대비가 뚜렷하고", e:"이목구비 대비가 뚜렷해서요", d:"이목구비 대비가 뚜렷해요"},
                    lo:{c:"이목구비가 부드럽게 어우러지고", e:"이목구비가 부드럽게 어우러져서요", d:"이목구비가 부드럽게 어우러져요"} },
};
